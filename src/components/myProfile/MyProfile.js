...
const MyProfile = () => {
    return (
        <div className='profile-card'>
            <div className='pc-im'>
                <img src={profileData.profileImg} alt={profileData.name} className='img-fluid' />
            </div>
            <div className='name-sec'>
                ...
                <div className='email-call-btn'>
                    <button className="btn" onClick={() => window.location = 'mailto:rs9097737511@gmail.com'}>Email</button>
                    <button className="btn" onClick={() => window.location = 'tel:9097737511'}>Call</button>
                </div>
            </div>
            <div className='other-details-sec'>
                <p className='address'><b>Address:</b>&nbsp;{profileData.address}</p>
                <p className='available'><b>Available:</b>&nbsp;{profileData.available}</p>
                <p className='email'><b>Email:</b>&nbsp;{profileData.email}</p>
                <p className='phone'><b>Phone:</b>&nbsp;{profileData.phone}</p>
                        ...
                        return (
                            <li key={id}>
                                <Link to={social.urlLink} target="_blank">
                                    <img src={social.iconurl} alt={social.title} className='img-fluid' />
